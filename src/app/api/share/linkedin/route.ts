...
import { runShareLinkedInGeneration } from "@/lib/ai/anthropic";
...
export async function POST(request: Request) {
  ...
  try {
    const result = await runShareLinkedInGeneration({
      messages,
    ...
    console.error("Share LinkedIn generation failed", error);
    return NextResponse.json(
