...
2. SETUP (1 paragraph): Establish what was at stake and what the founder was thinking going in. Use the kickoff gut feeling here.
...
4. PULL QUOTE: One line from the founder's retro — the most honest thing they said.
...
4. PULL QUOTE: The founder's most honest reaction from the retro — not a polished statement, a real one.
5. THE MEANING (1 paragraph): What this win actually means. Not what it means for the metrics — what it means for the founder and the story.
...
4. PULL QUOTE: The founder's most honest articulation of why they changed course.
...
6. CLOSE (2–3 sentences): The turn is complete. The next chapter begins from here. End with the founder standing in a new place, not a better place — just a different and more honest one.
`.trim(),

  // ── FOG ──────────────────────────────────────────────────────────────────────
  fog: `
This is a FOG chapter. Output was low. Uncertainty was high. The writing job is NOT to inflate what happened or frame incompletion as failure. Find the human experience of uncertainty and write toward that. The question to answer is not "what got done" but "what kept them going." Fog chapters are often the most relatable chapters in any founder story — write them that way.
...
3. THE ANCHOR (1 paragraph): The one thing the founder held onto. The belief, the small signal, the reason they kept showing up. This is the emotional core of the chapter. Find it in the retro stakes or personal meaning answers.
4. PULL QUOTE: The founder's most human moment from the retro — ideally something about perseverance, not accomplishment.
5. CLOSE (2–3 sentences): The fog hasn't fully lifted, but the founder is still standing. End with honest forward motion — not false optimism, just the act of continuing. The reader should finish the chapter still rooting for this person.

IMPORTANT FOR FOG: Before publishing, verify: Does this chapter make the reader respect the founder more, not less? Is there one human moment that makes it worth reading? Does it end with the reader still rooting for them? If any answer is no, rewrite.
`.trim(),
...
5. PULL QUOTE: Almost always from the learning answer — the moment the founder said something they didn't know they believed until they said it.
6. CLOSE (2–3 sentences): A door opening, not closing. The founder sees something now they couldn't see at the start of the chapter. End with that new visibility.
`.trim(),
};
