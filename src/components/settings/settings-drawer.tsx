    ...
    <div className="flex flex-col gap-6">
      ...
      {currentProjectId && currentProjectName && (
        <section className="rounded-[1.75rem] bg-white/90 p-5 ring-1 ring-black/6">
          ...
          <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
            Permanently deletes this project, all its chapters, boards, and tasks. This cannot be undone.
          </p>
          ...
          {confirmingDeleteProject ? (
            <div className="mt-4 rounded-[1.4rem] bg-rose-50 px-4 py-4 text-sm text-rose-700">
              ...
              <p className="mt-0.5 text-xs text-rose-600/80">
                <span className="font-mono font-semibold">{currentProjectName}</span>
              </p>
              <input
                type="text"
