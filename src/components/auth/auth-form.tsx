    ...
    <div className="flex min-h-screen items-start justify-center bg-white px-6 pt-12 pb-16" style={{ position: "relative" }}>
      ...
      <div className="flex w-full max-w-sm flex-col items-center gap-8" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="w-full flex flex-col gap-3">
          ...
          <form action={signInWithGoogleAction} onSubmit={requireTerms}>
            <TapeButton type="submit" variant="secondary" size="md" className="w-full justify-center">
          ...
          <form action={signInWithAppleAction} onSubmit={requireTerms}>
            <TapeButton type="submit" variant="primary" size="md" className="w-full justify-center">
